...
uses
  ...
  FMX.Colors, System.UIConsts, FMX.Edit, FMX.Platform, System.Actions, FMX.ActnList, FMX.Gestures;
...
type
  TFrmMain = class(TForm)
    ...
    procedure LeftExecute(Sender: TObject);
...
procedure TFrmMain.LeftExecute(Sender: TObject);
begin
  if TrackBar1.Value > 0 then
    TrackBar1.Value := TrackBar1.Value - 1;
end;

procedure TFrmMain.RightExecute(Sender: TObject);
begin
